# Generated by Django 2.2.16 on 2021-09-20 12:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='genre',
            name='name',
            field=models.CharField(max_length=256, verbose_name='genre'),
        ),
        migrations.AlterField(
            model_name='genre',
            name='slug',
        ...
        migrations.AlterField(
            model_name='review',
            name='score',
            field=models.PositiveSmallIntegerField(validators=[django.core.validators.MaxValueValidator(10, 'Максимальная оценка - 10'), django.core.validators.MinValueValidator(1, 'Минимальная оценка - 1')], verbose_name='score'),
        ),
        migrations.AlterField(
            model_name='review',
            name='title',
        ...
        migrations.AlterField(
            model_name='title',
            name='score',
            field=models.PositiveSmallIntegerField(null=True, validators=[django.core.validators.MaxValueValidator(10, 'Рейтинг не может быть выше 10'), django.core.validators.MinValueValidator(1)], verbose_name='score'),
        ),
        migrations.AlterField(
            model_name='title',
            name='year',
